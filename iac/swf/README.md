...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_artifactory_db"></a> [artifactory\_db](#module\_artifactory\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_confluence_db"></a> [confluence\_db](#module\_confluence\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_eks"></a> [eks](#module\_eks) | git::https://github.com/defenseunicorns/terraform-aws-eks.git | v0.0.22 |
| <a name="module_gitlab_db"></a> [gitlab\_db](#module\_gitlab\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_jira_db"></a> [jira\_db](#module\_jira\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_keycloak_db"></a> [keycloak\_db](#module\_keycloak\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_mattermost_db"></a> [mattermost\_db](#module\_mattermost\_db) | terraform-aws-modules/rds/aws | 6.7.0 |
...
| <a name="module_password_lambda"></a> [password\_lambda](#module\_password\_lambda) | git::https://github.com/defenseunicorns/terraform-aws-lambda.git//modules/password-rotation | v0.0.7 |
...
| [aws_secretsmanager_secret.notification-webhook](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/data-sources/secretsmanager_secret) | data source |
...
| <a name="input_bastion_cloudwatch_log_retention_days"></a> [bastion\_cloudwatch\_log\_retention\_days](#input\_bastion\_cloudwatch\_log\_retention\_days) | The number of days to retain the logs for the bastion instance | `number` | `30` | no |
...
| <a name="input_bastion_log_group_name"></a> [bastion\_log\_group\_name](#input\_bastion\_log\_group\_name) | The name of the CloudWatch Log Group for the bastion instance | `string` | `"bastion-logs"` | no |
...
| <a name="input_istio_admin_gateway_aws_load_balancer_attributes"></a> [istio\_admin\_gateway\_aws\_load\_balancer\_attributes](#input\_istio\_admin\_gateway\_aws\_load\_balancer\_attributes) | The attributes of the AWS Load Balancer to use for the Istio Admin Gateway | `string` | `"load_balancing.cross_zone.enabled=true"` | no |
| <a name="input_istio_admin_gateway_aws_load_balancer_nlb_target_type"></a> [istio\_admin\_gateway\_aws\_load\_balancer\_nlb\_target\_type](#input\_istio\_admin\_gateway\_aws\_load\_balancer\_nlb\_target\_type) | The target type of the AWS Load Balancer to use for the Istio Admin Gateway | `string` | `"instance"` | no |
| <a name="input_istio_admin_gateway_aws_load_balancer_scheme"></a> [istio\_admin\_gateway\_aws\_load\_balancer\_scheme](#input\_istio\_admin\_gateway\_aws\_load\_balancer\_scheme) | The scheme of the AWS Load Balancer to use for the Istio Admin Gateway | `string` | `"internal"` | no |
| <a name="input_istio_admin_gateway_aws_load_balancer_type"></a> [istio\_admin\_gateway\_aws\_load\_balancer\_type](#input\_istio\_admin\_gateway\_aws\_load\_balancer\_type) | The type of AWS Load Balancer to use for the Istio Admin Gateway | `string` | `"external"` | no |
| <a name="input_istio_passthrough_gateway_aws_load_balancer_attributes"></a> [istio\_passthrough\_gateway\_aws\_load\_balancer\_attributes](#input\_istio\_passthrough\_gateway\_aws\_load\_balancer\_attributes) | The attributes of the AWS Load Balancer to use for the Istio Passthrough Gateway | `string` | `"load_balancing.cross_zone.enabled=true"` | no |
| <a name="input_istio_passthrough_gateway_aws_load_balancer_nlb_target_type"></a> [istio\_passthrough\_gateway\_aws\_load\_balancer\_nlb\_target\_type](#input\_istio\_passthrough\_gateway\_aws\_load\_balancer\_nlb\_target\_type) | The target type of the AWS Load Balancer to use for the Istio Passthrough Gateway | `string` | `"instance"` | no |
| <a name="input_istio_passthrough_gateway_aws_load_balancer_scheme"></a> [istio\_passthrough\_gateway\_aws\_load\_balancer\_scheme](#input\_istio\_passthrough\_gateway\_aws\_load\_balancer\_scheme) | The scheme of the AWS Load Balancer to use for the Istio Passthrough Gateway | `string` | `"internal"` | no |
| <a name="input_istio_passthrough_gateway_aws_load_balancer_type"></a> [istio\_passthrough\_gateway\_aws\_load\_balancer\_type](#input\_istio\_passthrough\_gateway\_aws\_load\_balancer\_type) | The type of AWS Load Balancer to use for the Istio Passthrough Gateway | `string` | `"external"` | no |
| <a name="input_istio_tenant_gateway_aws_load_balancer_attributes"></a> [istio\_tenant\_gateway\_aws\_load\_balancer\_attributes](#input\_istio\_tenant\_gateway\_aws\_load\_balancer\_attributes) | The attributes of the AWS Load Balancer to use for the Istio Tenant Gateway | `string` | `"load_balancing.cross_zone.enabled=true"` | no |
| <a name="input_istio_tenant_gateway_aws_load_balancer_nlb_target_type"></a> [istio\_tenant\_gateway\_aws\_load\_balancer\_nlb\_target\_type](#input\_istio\_tenant\_gateway\_aws\_load\_balancer\_nlb\_target\_type) | The target type of the AWS Load Balancer to use for the Istio Tenant Gateway | `string` | `"instance"` | no |
| <a name="input_istio_tenant_gateway_aws_load_balancer_scheme"></a> [istio\_tenant\_gateway\_aws\_load\_balancer\_scheme](#input\_istio\_tenant\_gateway\_aws\_load\_balancer\_scheme) | The scheme of the AWS Load Balancer to use for the Istio Tenant Gateway | `string` | `"internal"` | no |
| <a name="input_istio_tenant_gateway_aws_load_balancer_type"></a> [istio\_tenant\_gateway\_aws\_load\_balancer\_type](#input\_istio\_tenant\_gateway\_aws\_load\_balancer\_type) | The type of AWS Load Balancer to use for the Istio Tenant Gateway | `string` | `"external"` | no |
...
| <a name="output_subnet_addrs"></a> [subnet\_addrs](#output\_subnet\_addrs) | Subnet Addrs module output data |
